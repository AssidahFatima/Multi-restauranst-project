...
@section('content')
    <div class="header">
        <div class="row clearfix">
            <div class="col-md-12">
                <h3 class="">{{$lang->get(648)}}</h3>       {{--Orders - Orders Management--}}
            </div>
        </div>
    </div>
    <div class="body">
                    ...
                    <div class="row clearfix js-sweetalert">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="card">
                                ...
                                <div class="body">
                                    @include('elements.driversTable', array())
                                </div>
        ...
        <div class="col-md-12">
            <table class="table">
                ...
                <tr>
                    ...
                    <td style="text-align:left" >
                        <button class="button button1">{{$lang->get(643)}}</button>
                    </td>

                    <td style="text-align:left" >
                        <button class="button button2">{{$lang->get(645)}}</button>
                    </td>
